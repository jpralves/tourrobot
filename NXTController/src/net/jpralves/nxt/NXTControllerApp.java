 ...
 * 
 */
public class NXTControllerApp extends Application {

	private static final String TAG = NXTControllerApp.class.getSimpleName();

	private static final String CAPTUREFOLDERNAME = "NXTControllerCapture";
