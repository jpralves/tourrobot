...
function generateTOC(toc) {
	...
	for (var i = 0; i < document.body.childNodes.length; ++i) {
		...
		if (tagName == "h4") {
			...
			++i2, i3 = 0, i4 = 0;
			if (i2 == 1) toc.appendChild(document.createElement("ul"));
			var section = i1 + "." + i2;
			node.insertBefore(document.createTextNode(section + ". "), node.firstChild);
			node.id = "section" + section;
			toc.lastChild.appendChild(document.createElement("li")).appendChild(createLink("#section" + section, node.innerHTML));
		}
		else if (tagName == "h1") {
			++i1, i2 = 0, i3 = 0, i4 = 0;
			var section = i1;
